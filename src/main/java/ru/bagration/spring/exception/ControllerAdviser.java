...
public class ControllerAdviser extends ResponseEntityExceptionHandler {
    ...
    ResponseEntity<?> handleNotValidArgumentException(MethodArgumentNotValidException ex, WebRequest request){
        var map = new HashMap<String, String>();
        map.put("errorMessage", "not valid");
        return response(map);
    }*/
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        System.out.println("--------------");
        var responseData = new ResponseData<>(null, errorMessageService.findByKeyAndLang(errorMessage, lang));
